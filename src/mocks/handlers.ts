...
export const handlers = [
  http.get("https://z6q58moouj.execute-api.eu-west-2.amazonaws.com/prod/ksbs", ({ request }) => {
    return HttpResponse.json(ksbs);
  }),

  http.delete("https://z6q58moouj.execute-api.eu-west-2.amazonaws.com/prod/ksbs/:id", ({ params }) => {
    ksbs = ksbs.filter((ksb) => ksb.id != params.id);
    return HttpResponse.json({}, { status: 204 });
  }),

  http.post("https://z6q58moouj.execute-api.eu-west-2.amazonaws.com/prod/ksbs/:type", async ({ request, params }) => {
  ...
  http.put("https://z6q58moouj.execute-api.eu-west-2.amazonaws.com/prod/ksbs/:id", async ({ request, params }) => {
